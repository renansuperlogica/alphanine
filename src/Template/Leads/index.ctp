...
<body>
          ...
          <div class="wrapper" id="aqui">
                          ...
                          <div class="saibaleft">
                            ...
                            <div class="alpha-text">Com o objetivo de trazer conte&uacute;do relevante, como nosso e-book original <b style=" color:#40b2df">PIMP MY PPT</b>, queremos proporcionar uma experi&ecirc;ncia empreendedora e divertida para voc&ecirc; se tornar um designer cada vez melhor.</div>
                            <br>
                            
                          </div>

                          <div class="formright">
                            <div class="quer">Quer ficar por dentro das &uacute;ltimas novidades? Receber not&iacute;cias fresquinhas em seu e-mail? Preencha a&ecirc;!!
                            </div>
                            <br>
...
Com o objetivo de trazer conteúdos relevantes, queremos proporcionar uma experiência empreendedora e divertida para você ser a sua própria melhor versão. <p/>
         ...
         -->
          ...
          <div><h1 class="name"><h2>Deseja receber conteúdos relevantes em seu e-mail?</h2></div>
          <br>
          <div><p>Distribuímos conteúdo relevante para designers como e-books gratuitos e artigos sobre a área. Um exemplo é um guia rápido para você fazer apresentações de impressionar. Este guia foi preparado para dar as principais noções de apresentação de slides, seja no Power Point, Keynote ou outro software similar. Você vai conseguir encontrar noções e dicas de como definir tamanhos e proporção de slides, quais informações colocar em um slide e muito mais sobre imagens e ícones. Esperamos que você curta bastante o material, que ele te ajude a fazer apresentações incríveis e que continue aproveitando os conteúdos da Alphanine.   <p/></div>
